      ...
      <div className="bg-white p-4">
        ...
        <Form onSubmit={handleSubmit}>
          <Form.Group controlId="username">
            ...
            <Form.Control type="text" name="username" className="w-full px-5 py-2 border rounded-lg" onChange={handleChange} />
          </Form.Group>
          ...
          <Button disabled={loading} variant="primary" type="submit" className="w-100 --btn mt-3" style={{ color: 'grey', border: 'none', fontWeight: 'bold', textTransform: 'uppercase' }}>
